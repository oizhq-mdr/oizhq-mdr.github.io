...
const publication = defineCollection({
  // Load Markdown files in the `src/content/publication/` directory.
  loader: glob({ base: './src/content/publication', pattern: '**/*.md' }),
  // Type-check frontmatter using a schema
  schema: z.object({})
})
...
export const collections = { posts, about, publication, cv }
